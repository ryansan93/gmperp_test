<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	<div class="col-xs-12 no-padding">
		<div class="col-xs-3 no-padding"><label class="label-control">Tanggal Pakai DN</label></div>
...
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	<div class="col-xs-12 no-padding">
		<div class="col-xs-3 no-padding"><label class="label-control">Total Pakai DN</label></div>
