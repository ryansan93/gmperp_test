...
<div class="form-group d-flex align-items-center <?php echo $hide; ?>">
	<div class="col-lg-12 d-flex align-items-center no-padding">
		...
		<div class="col-lg-10">
			: <label class="control-label"><?php echo (isset($data_ov['nama_prs']) && !empty($data_ov['nama_prs'])) ? strtoupper($data_ov['nama_prs']) : null; ?></label>
		</div>
	</div>
</div>
<div class="form-group d-flex align-items-center">
					...
					<tr>
						<td>
							...
							?> -->
							 ...
							 <?php echo $v_det['d_barang']['kode'].' - '.$v_det['d_barang']['nama']; ?>
						</td>
						<td>
...
<!-- < ?php if ( !$terima ): ?> -->
	<div class="form-group d-flex align-items-center lock_btn_fiskal" data-date="<?php echo substr($data['tgl_kirim'], 0, 10); ?>">
		<div class="col-lg-12">
			...
			<button type="button" class="btn btn-danger cursor-p pull-right" title="ADD" style="margin-right: 5px;" jenis="ovk" data-id="<?php echo $data['id']; ?>" onclick="pp.delete(this)"> 
