				...
				<div class="tab-content">
					<div id="riwayat" class="tab-pane fade show active">
						...
						<div class="col-sm-3 no-padding" style="margin-bottom:10px;">
							<button id="btn-tampil" type="button" data-href="action" class="btn btn-primary cursor-p " title="TAMPIL" onclick="pv.get_lists()" style="margin-right: 10px;">Tampilkan</button>
							<button id="btn-add" type="button" data-href="pengiriman" class="btn btn-primary cursor-p " title="ADD" onclick="pv.changeTabActive(this)"><i class="fa fa-plus" aria-hidden="true"></i> ADD</button>
						</div>
