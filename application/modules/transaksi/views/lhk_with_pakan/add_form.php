	...
	<div class="col-xs-12">
		<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
			...
			<div class="col-xs-8 no-padding" style="padding-left: 5px;">
				<div class="col-xs-9 no-padding" style="padding-right: 5px;">
					<div class="col-xs-12 no-padding">
						<label class="control-label">Pakai Pakan (Zak)</label>
					</div>
					<div class="col-xs-12 no-padding">
						<input class="form-control text-right" data-tipe="integer" type="text" name="pakai_pakan" data-required="1" placeholder="PAKAI PAKAN" readonly />
					</div>
				</div>
				<div class="col-xs-3 no-padding" style="padding-left: 5px;">
					...
					<div class="col-xs-12 no-padding">
						<button type="button" class="col-xs-12 btn btn-default" onclick="lhk.cek_data_pakan(this)">
							<i class="fa fa-list"></i>
						</button>

						<!-- Modal -->
						<div class="modal fade" id="modalPakaiPakan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">PEMAKAIAN PAKAN</h5>
									</div>
