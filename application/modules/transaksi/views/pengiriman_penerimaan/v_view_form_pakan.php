...
<div class="form-group d-flex align-items-center lock_btn_fiskal" data-date="<?php echo substr($data['tgl_kirim'], 0, 10); ?>">
	<div class="col-lg-12">
		...
		<!-- < ?php if (!$terima ): ?> -->
			...
			<button type="button" class="btn btn-danger cursor-p pull-right" title="ADD" style="margin-right: 5px;" jenis="pakan" data-id="<?php echo $data['id']; ?>" onclick="pp.delete(this)"> 
