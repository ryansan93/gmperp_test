		...
		<form role="form" class="form-horizontal">
			<div class="panel-heading">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#riwayat" data-tab="riwayat">Riwayat Pengiriman & Penerimaan</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#pengiriman" data-tab="pengiriman">Pengiriman & Penerimaan Pakan</a>
					</li>
				</ul>
			</div>
				...
				<div class="tab-content">
					<div id="riwayat" class="tab-pane fade show active">
						...
						<div class="col-sm-3 no-padding" style="margin-bottom:10px;">
							<button id="btn-tampil" type="button" data-href="action" class="btn btn-primary cursor-p" title="TAMPIL" onclick="pp.get_lists()" style="margin-right: 10px;">Tampilkan</button>
							<button id="btn-add" type="button" data-href="pengiriman" class="btn btn-primary cursor-p" title="ADD" onclick="pp.changeTabActive(this)"><i class="fa fa-plus" aria-hidden="true"></i> ADD</button>
						</div>
