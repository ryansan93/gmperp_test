...
class LHK_WITH_PAKAN extends Public_Controller
{
    private $pathView = 'transaksi/lhk_with_pakan/';
    private $upload_path;
    private $url;
    /**
     * Constructor
        ...
        // if ( $akses['a_view'] == 1 ) {
            ...
            $this->add_external_js(
                array(
                    ...
                    'assets/transaksi/lhk_with_pakan/js/lhk.js'
                )
            );
            $this->add_external_css(
                array(
                    "assets/select2/css/select2.min.css",
                    'assets/transaksi/lhk_with_pakan/css/lhk.css'
                )
            );
            $data = $this->includes;
        ...
        try {
            ...
            if ( $d_conf->count() > 0 ) {
                ...
                foreach ($d_conf as $k_conf => $v_conf) {
                    $html .= "
                        <tr>
                            <td>".$v_conf['nama_barang']."</td>
                            <td>
                                <input type='text' class='form-control jumlah' data-tipe='integer' placeholder='Jumlah (Zak)' maxlength='7'>
                            </td>
                        </tr>
                    ";
                }
                ...
                $html .= "
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class='text-right tot_pakai_pakan'><b>0</b></td>
                                </tr>
                            </tfoot>
                        </table>
                    </small>
