...
class PengirimanPenerimaan extends Public_Controller
{
    private $url;
    private $hakAkses;
    ...
    public function index()
    {
        if ( $this->hakAkses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                'assets/transaksi/pengiriman_penerimaan/js/pengiriman-penerimaan.js'
            ));
            $this->add_external_css(array(
                'assets/select2/css/select2.min.css',
                'assets/transaksi/pengiriman_penerimaan/css/pengiriman-penerimaan.css'
            ));
            ...
            $data                           = $this->includes;
            $data['title_menu']             = 'Pengiriman & Penerimaan';
            ...
            $content['add_form_pakan']      = $this->load->view('transaksi/pengiriman_penerimaan/v_add_form_pakan', $pakan_content, TRUE);
            ...
            $content['add_form_ovk']        = $this->load->view('transaksi/pengiriman_penerimaan/v_add_form_ovk', $ovk_content, TRUE);

            $data['view']       = $this->load->view('transaksi/pengiriman_penerimaan/v_index', $content, true);
    ...
    public function get_lists()
    {
        ...
        if($params['jenis'] == 'PAKAN'){
            $content['data_pakan']  = $this->listDataPakan($params);
            $html = $this->load->view('transaksi/pengiriman_penerimaan/v_list_pakan', $content, true);
        } else {
            $content['data_ovk']    = $this->listDataOvk($params );
            $html = $this->load->view('transaksi/pengiriman_penerimaan/v_list_ovk', $content, true);
        }
        ...
        try {
            ...
            if ( !empty($kode_unit) ) {
                ...
                // Penerimaan Pakan
                    ...
                    $m_terima_pakan->tgl_terima     = $params['tgl_kirim'];
    ...
    public function save_ovk()
    {
        ...
        try {
            ...
            if ( !empty($kode_unit) ) {
                ...
                $m_terima_voadip->tgl_terima        = $params['tgl_kirim'];;
    ...
    public function get_list_table()
    {
        ...
        try {
            ...
            $content['data'] = $data;
            $html = $this->load->view('transaksi/pengiriman_penerimaan/v_list_order_pakan', $content, TRUE);
     ...
     public function listActivity()
    {
        ...
        if($params['jenis_transaksi'] == 'PAKAN'){
            $m_kirim_pakan = new \Model\Storage\KirimPakan_model();
        ...
        $html = $this->load->view('transaksi/pengiriman_penerimaan/v_list_activity', $content, true);
    ...
    public function load_form_pakan()
    {
        ...
        if ( !empty($id) ) {
            ...
            if ( $resubmit == 'edit' ) {
                $html = $this->load->view('transaksi/pengiriman_penerimaan/v_edit_form_pakan', $a_content, TRUE);
            } else {
                $html = $this->load->view('transaksi/pengiriman_penerimaan/v_view_form_pakan', $a_content, TRUE);
            }
        } else {
            $html = $this->load->view('transaksi/pengiriman_penerimaan/v_add_form_pakan', $a_content, TRUE);
        }
    ...
    public function load_form_ovk()
    {
        ...
        if ( !empty($id) ) {
            ...
            if ( $resubmit == 'edit' ) {
                $html = $this->load->view('transaksi/pengiriman_penerimaan/v_edit_form_ovk', $a_content, TRUE);
            } else {
                $html = $this->load->view('transaksi/pengiriman_penerimaan/v_view_form_ovk', $a_content, TRUE);
            }
        } else {
            $html = $this->load->view('transaksi/pengiriman_penerimaan/v_add_form_ovk', $a_content, TRUE);
        }
