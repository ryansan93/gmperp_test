...
<div class="col-xs-12 no-padding">
    <button type="button" class="btn btn-primary pull-right" onclick="km.edit(this)" data-kode="<?php echo $data['no_km']; ?>" data-nominalold="<?php echo $data['nilai']; ?>" data-usersubmit="<?php echo $log['user_id']; ?>" data-useredit="<?php echo $userid; ?>" style="margin-left: 5px;">
