                                        ...
                                        <table class="table table-bordered tbl_detail" style="margin-bottom: 0px; max-width: 100%; width: 100%; font-size:10px;">
                                            ...
                                            <tbody>
                                                <tr class="data" data-urut="">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-default keterangan uppercase" placeholder="Keterangan" maxlength="50">
                                                    </td>
                                            
                                                    <td>
                                                        <input type="text" class="form-default text-right nilai uppercase" placeholder="Nilai" data-tipe="decimal" maxlength="19" data-required="1" onblur="mm.hitGrandTotal(this)">
                                                    </td>
                                                    <td>
                                                        <div class="col-xs-12 no-padding">
