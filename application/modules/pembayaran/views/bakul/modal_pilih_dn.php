...
<div class="modal-body modal_dn" style="padding-bottom: 0px;">
	<div class="row detailed">
					...
					<?php if ( !empty($data) ): ?>
						<?php foreach ($data as $k_data => $v_data): ?>
							<tr class="data">
								...
								<td class="text-right">
									<input type="text" class="form-control uppercase text-right pakai" placeholder="Pakai" data-tipe="decimal" data-required="1" onblur="bakul.cekPakaiDN(this)">
								</td>
		...
		<div class="col-xs-12 detailed no-padding">
			...
			<div class="col-xs-6 no-padding" style="padding-left: 5px;">
				<button type="button" class="col-xs-12 btn btn-primary" onclick="bakul.pilihDN(this)"><i class="fa fa-check"></i> Pilih</button>
			</div>
		</div>
	</div>
</div>