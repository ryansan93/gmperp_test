    ...
    <?php foreach ($data as $key => $value) { ?>
        <?php if ( $kode_kas <> $value['kas'] ) { ?>
            ...
            <tr>
				...
				<td class="col-xs-1 text-center"><b>Plasma</b></td>
				<td class="col-xs-1 text-center"><b>Noreg</b></td>
				<td class="col-xs-3 text-center"><b>Keterangan</b></td>
        ...
        <tr>
            ...
            <td><?php echo strtoupper($nama_mitra); ?></td>
            <td><?php echo strtoupper($noreg.'<br>'.tglIndonesia($tgl_docin, '-', ' ')); ?></td>
