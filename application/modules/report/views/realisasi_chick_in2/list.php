    ...
    <?php foreach ($data as $key => $value) { ?>
        ...
        <tr>
            <?php if ( !isset($data[ $key-1 ]) || $value['noreg'] <> $data[ $key-1 ]['noreg'] ) { ?>
                ...
                <td rowspan="<?php echo $row_span; ?>" class="text-center"><?php echo strtoupper(tglIndonesia($value['real_tgl_docin'], '-', ' ')).' '.substr($value['real_tgl_docin'], 11, 5); ?></td>
            <?php } ?>
            ...
            <?php if ( !isset($data[ $key-1 ]) || $value['noreg'] <> $data[ $key-1 ]['noreg'] ) { ?>
                <td rowspan="<?php echo $row_span; ?>" class="text-center"><?php echo strtoupper(tglIndonesia($value['tgl_panen'], '-', ' ')); ?></td>
                <td rowspan="<?php echo $row_span; ?>" class="text-center"><?php echo strtoupper(tglIndonesia($value['tgl_tutup'], '-', ' ')); ?></td>
            <?php } ?>
