<?php if ( !empty($data) && count($data) > 0 ) { ?>
    ...
    <tr class="abu">
        ...
        <td style="width: 6%"><b>Kredit</b></td>
        <td style="width: 6%"><b>Saldo Akhir</b></td>
        <td style="width: 6%"><b>Current</b></td>
        <td style="width: 6%"><b>Umur 1-7 Hari</b></td>
        <td style="width: 6%"><b>Umur 8-14 Hari</b></td>
        <td style="width: 6%"><b>Umur 15-21 Hari</b></td>
        <td style="width: 6%"><b>Umur 22-30 Hari</b></td>
        <td style="width: 6%"><b>Umur 31-60 Hari</b></td>
        <td style="width: 6%"><b>Umur 61-90 Hari</b></td>
        <td style="width: 6%"><b>Umur > 90 Hari</b></td>
    </tr>
    <?php foreach ($data as $key => $value) { ?>
        <tr>
            ...
            <td class="text-right"><?php echo ($value['umur5'] >= 0) ? angkaDecimal($value['umur5']) : '('.angkaDecimal(abs($value['umur5'])).')'; ?></td>
            <td class="text-right"><?php echo ($value['umur6'] >= 0) ? angkaDecimal($value['umur6']) : '('.angkaDecimal(abs($value['umur6'])).')'; ?></td>
            <td class="text-right"><?php echo ($value['umur7'] >= 0) ? angkaDecimal($value['umur7']) : '('.angkaDecimal(abs($value['umur7'])).')'; ?></td>
        </tr>
    ...
    <tr class="kuning">
        ...
        <td class="text-right"><b><?php echo angkaDecimal($gt_umur5); ?></b></td>
        <td class="text-right"><b><?php echo angkaDecimal($gt_umur6); ?></b></td>
        <td class="text-right"><b><?php echo angkaDecimal($gt_umur7); ?></b></td>
    </tr>
<?php } else { ?>
    <tr>
