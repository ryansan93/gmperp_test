    ...
    <?php foreach ($data as $key => $value) { ?>
        <?php if ( $kode_gudang <> $value['kode_gudang'] ) { ?>
            ...
            <tr>
                ...
                <td class="col-xs-2 text-center hide" style="vertical-align: middle;"><b>Jenis Transaksi</b></td>
        ...
        <tr>
            ...
            <td class="hide"><?php echo strtoupper($value['jenis_trans']); ?></td>
        ...
        <?php if ( !empty($kode_gudang) && $kode_gudang <> $data[$key+1]['kode_gudang'] ) { ?>
            <tr class="biru">
                <td colspan="5"><b>Total Per Gudang</b></td>
