var gl = {
    ...
    getLists: function () {
		...
		if ( err > 0 ) {
			...
			$.ajax({
                url : 'report/GeneralLedgerExternal/getLists',
                data : {
                    'params' : params
                },
                type : 'GET',
	...
	formDetail: function(elm) {
		...
		$.get('report/GeneralLedgerExternal/formDetail',{
				'params': params
			},function(data){
			hideLoading();
			var _options = {
    ...
    encryptParams: function() {
		...
		if ( err > 0 ) {
			...
			$.ajax({
	            url: 'report/GeneralLedgerExternal/encryptParams',
	            data: {
	                'params': params
	            },
	            type: 'POST',
	...
	exportExcel : function (params) {
		goToURL('report/GeneralLedgerExternal/exportExcel/'+params);
	}, // end - exportExcel
};
