var km = {
	...
	setting_up: function() {
        ...
        $('select.bank').select2().on('select2:select', function (e) {
            ...
            km.getNoreg( data.unit );
        });

        km.getNoreg( $('select.bank').find('option:selected').attr('data-unit') );
    }, // end - setting_up
    ...
    getNoreg: function(unit) {
        ...
        $.ajax({
            url : 'accounting/KasMasukInternal/getNoreg',
            data : {
                'params' : params
            },
            type : 'GET',
    ...
    loadForm: function(v_id = null, resubmit = null) {
        ...
        $.ajax({
            url : 'accounting/KasMasukInternal/loadForm',
            data : {
                'id' :  v_id,
                'resubmit' : resubmit
            },
	...
	getLists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url : 'accounting/KasMasukInternal/getLists',
                data : {
                    'params' : params
                },
                type : 'GET',
    ...
    //     $.ajax({
    //         url : 'accounting/KasMasukInternal/getNoFaktur',
    //         data : {
    //             'params' : params
    //         },
    //         type : 'GET',
        ...
        if ( status == 0 ) {
			...
			bootbox.confirm( keterangan , function(result) {
                if ( result ) {
                    ...
                    $.ajax({
                        url: 'accounting/KasMasukInternal/save',
                        dataType: 'json',
                        type: 'post',
                        data: {
                            'params': data
        ...
        if ( status == 0 ) {
			...
			bootbox.confirm( keterangan , function(result) {
                if ( result ) {
                    ...
                    $.ajax({
                        url: 'accounting/KasMasukInternal/edit',
                        dataType: 'json',
                        type: 'post',
                        data: {
                            'params': data
    ...
    delete: function(elm) {
        ...
        bootbox.confirm('Apakah anda yakin ingin meng-hapus data ?', function(result) {
            if ( result ) {
                ...
                $.ajax({
                    url: 'accounting/KasMasukInternal/delete',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        'params': params
    ...
    printPreview: function (elm) {
        ...
        window.open('accounting/KasMasukInternal/printPreview/'+no_so, 'blank');
    }, // end - printPreview
    ...
    exportPdf : function (elm) {
        ...
        $.ajax({
            url: 'accounting/KasMasukInternal/exportPdf',
            dataType: 'json',
            type: 'post',
            data: {
                'params': params
