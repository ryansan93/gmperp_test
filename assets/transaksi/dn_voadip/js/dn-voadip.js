var dn = {
	...
	setSelect2NoSj: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/DnVoadip/getNoSj',
                dataType: 'json',
                type: 'GET',
    ...
    getLists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url: 'transaksi/DnVoadip/getLists',
                data: { 'params': params },
                type: 'GET',
                dataType: 'HTML',
	...
	loadForm: function(id, edit, href) {
		...
		$.ajax({
            url: 'transaksi/DnVoadip/loadForm',
            data: { 'params': params },
            type: 'GET',
            dataType: 'HTML',
